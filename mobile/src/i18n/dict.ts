...
export const dict = {
  en: {
    ...
    blockUserConfirm: 'Block {name}? You won’t see their posts anymore.',
    alreadyReportedTitle: 'Already reported',
    alreadyReportedBody: "You've already reported this post.",
    delete: 'Delete',
    cancel: 'Cancel',
  ...
  es: {
    ...
    deletePostConfirm: 'Eliminar esta publicación? Esta acción no se puede deshacer.',
    reportPost: 'Reportar publicación',
    reportReasonSpam: 'Spam',
    reportReasonHarassment: 'Acoso',
    reportReasonOther: 'Otro',
    blockUser: 'Bloquear usuario',
    blockUserConfirm: 'Bloquear a {name}? Ya no verás sus publicaciones.',
    alreadyReportedTitle: 'Ya reportado',
    alreadyReportedBody: 'Ya has reportado esta publicación.',
    delete: 'Eliminar',
    cancel: 'Cancelar',
